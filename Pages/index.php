...
<html lang="en">
  ...
  <body>
    <header class="head-section">
      ...
      <a href="" class="navlink" id="menu-icon"
        ...
        <div class="product-lineup">
          <div class="product-card">
            <figure class="product-figure">
              <img
                src="../headphone_resources/headphone1.jpg"
                alt="Boult Audio Headset"
                class="product-image"
              />
            </figure>
          ...
          <div class="product-card">
            <figure class="product-figure">
              <img
                src="../headphone_resources/headphone3.jpg"
                alt="Zebronics Headdet"
                class="product-image"
              />
            </figure>
            <div class="product-data-section">
