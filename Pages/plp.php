...
<head>
  ...
  <link rel="stylesheet" href="../Stylesheets/plpstyle.css" />
  <link
    rel="stylesheet"
...
<body>
  ...
  <main>
    <div class="main-container">
      ...
      <h2 class="product-catagory-heading">Headphone Store</h2>
     ...
     <section class="product-gallery" id="product-gallery">
      <h2 class="product-gallary-heading">Top Trending Products</h2>
...
<script src="../Scripts/productFetchingPlp.js"></script>
<script>
